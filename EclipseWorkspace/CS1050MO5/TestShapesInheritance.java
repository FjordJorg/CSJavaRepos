...
public class TestShapesInheritance
{
	...
	{
		CircleFromSimpleGeometricShape circle = new CircleFromSimpleGeometricShape(
				1);
		...
		CircleFromSimpleGeometricShape circle2 = new CircleFromSimpleGeometricShape(
				2);
...
class SimpleGeometricShape
{
	...
	/**
	 * Since filled is boolean, its get method is named isFilled get current
	 * filled value
	 * 
...
class CircleFromSimpleGeometricShape extends SimpleGeometricShape
{
	...
	public CircleFromSimpleGeometricShape(double radius, String color,
			boolean filled)
	{
		this.radius = radius;
		setColor(color);
